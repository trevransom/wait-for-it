...
public class gameMain extends JFrame {
	...
	private JPanel LayeredPanel = null;
	...
	private void initialize() {
		...
		//this.LayeredPanel = new JPanel();
		//this.LayeredPanel.setLayout(new GridBagLayout());
		...
		//I'm going to change this from a label to a newJPanel
		//JPanel background = 
